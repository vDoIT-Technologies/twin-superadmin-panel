    ...
    <section className="space-y-6 px-4 py-6 sm:px-6 lg:px-8">
      <header>
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Manage your superadmin identity, contact details, and account preferences.</p>
        </div>
      </header>

      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <aside className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-panel lg:col-span-1">
          <div className="h-28 bg-gradient-to-r from-indigo-600 via-indigo-700 to-blue-600" />
          <div className="px-6 pb-6">
            <div className="-mt-12 flex justify-start">
              <div className="flex h-20 w-20 items-center justify-center rounded-full border-4 border-white bg-indigo-600 text-xl font-bold text-white shadow-md">
                {initials}
              </div>
            </div>
            ...
            <div className="mt-4">
              ...
              <span className="mt-1 inline-flex items-center rounded-md bg-indigo-50 px-2.5 py-0.5 text-xs font-semibold text-indigo-700">
            ...
            <div className="mt-6 space-y-3">
              ...
              <div className="flex items-center gap-3 rounded-xl border border-slate-100 bg-slate-50/80 px-3.5 py-2.5 text-xs font-medium text-slate-700">
                ...
                <span className="truncate">{draft.company || 'Twin Protocol'}</span>
              </div>
            </div>
          </div>
        </aside>
          ...
          <div className="grid grid-cols-1 gap-5 p-6 sm:grid-cols-2">
            ...
            <label className="grid gap-1.5">
              ...
              <input
                ...
                placeholder="e.g. Platform SuperAdmin"
              />
            </label>
